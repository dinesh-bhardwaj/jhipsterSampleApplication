...
describe('Service Tests', () => {
    ...
    describe('RNS_CRM_REQUEST_MASTER Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RNS_CRM_REQUEST_MASTERService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/rns-crm-request-masters';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RNS_CRM_REQUEST_MASTER', () => {
